        ...
        <?php 
            ...
            if(isset($_GET['id']))
            {
                ...
                else
                {
                    ...
                    $_SESSION['notfound'] = "<div class='error'>Dish not Found.</div>";
                    ...
                    <td>
                        <?php 
                            if($current_image != "")
                            {
                                //Display the Image
                                ?>
                                <img src="<?php echo $SITEURL; ?>images/dishes/<?php echo $current_image; ?>" width="150px">
                                <?php
                            }
                            else
                            {
            ...
            if(isset($_POST['submit']))
            {
                ...
                if(isset($_FILES['image']['name']))
                {
                    ...
                    if($image_name != "")
                    {
                        ...
                        //Rename the Image
                        $image_name = "dish_name_".rand(000, 999).'.'.$ext; // e.g. Food_Category_834.jpg
                        ...
                        if($current_image!="")
                        {
                            $remove_path = "images/dishes/".$current_image;
                ...
                else
                {
                    ...
                    $_SESSION['update'] = "<div class='error'></div>";
                    header('location:'.SITEURL.'ManageDishes.php');
                }
